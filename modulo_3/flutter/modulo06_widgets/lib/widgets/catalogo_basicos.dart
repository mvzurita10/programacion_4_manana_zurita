...
SizedBox(
  ...
  child: Text(
    ...
    softWrap: false,                 // si false, ignora maxLines y overflow, y muestra todo en una línea
  ),
),
const SizedBox(height: 8),
...
Wrap(
  ...
  children: [
    ...
    IconButton(
      onPressed: () {},
      tooltip: 'Detiene todos los servicios', // mostrado al mantener presionado o al pasar el mouse
...
Card(
  ...
  child: ListTile(
    ...
    subtitle: const Text('Cristiano Ronaldo afronta su sexto Mundial con Portugal y busca el único gran título '),
...
// ── Chips: etiquetas, filtros o acciones compactas ───────────────────
Wrap(
  spacing: 8, runSpacing: 8,
  children: [
